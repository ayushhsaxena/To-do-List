...
root.title('Ayush saxena to-do-list')
...
def add_task():
    ...
    if task != '':
        ...
        display['text'] = "Enter whats on your mind"
...
title = tkinter.Label(root, text = "to-do-list", bg='lightgreen')
title.grid(row=0,column=0)


display = tkinter.Label(root, text = "", bg='red')
